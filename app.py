...
/* Prevent expander content from flashing/disappearing on hover.
   ...
   Broad selector (no [open] parent) handles cases where React temporarily moves the
   element out of the [open] parent during re-render. */
details[data-testid="stExpander"][open] > div[data-testid="stExpanderDetails"],
[data-testid="stExpanderDetails"] {
    opacity: 1 !important; visibility: visible !important; display: block !important;
    transform: translateZ(0); will-change: transform; transition: none !important; pointer-events: auto !important; }
[data-testid="stExpander"] { overflow: visible !important; }
[data-testid="stExpander"] [data-testid="stVerticalBlockBorderWrapper"] { height: auto !important; overflow: visible !important; min-height: 0 !important; }
