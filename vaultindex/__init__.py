...
later local embeddings) that can be deleted and rebuilt at any moment, and answers
queries from the CLI (`python -m vaultindex ...`) and from the `techcolab-vault` MCP.
No LLM anywhere in the path. Nothing leaves the machine.
