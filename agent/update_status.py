...
def update_status(idea_id: str, new_status: str) -> None:
    ...
    # The vault's _index.md is regenerated by the Streamlit app only. Toolkit 2.0 made this
    # CLI the canonical path, so without this the Obsidian index rots (it was 10 days stale
    # on 2026-08-31). Best-effort: a broken index must never fail a status change.
    try:
